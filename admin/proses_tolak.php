...
if(isset($_GET['id'])) {
    ...
    // Update submission status to 'ditolak'
    ...
    if($query) {
        ...
        try {
                        ...
                        <body style='font-family: Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f4f4f4; margin: 0; padding: 0;'>
                            <div style='max-width: 600px; margin: 20px auto; background-color: white; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);'>
                                <div style='background-color: #dc3545; color: white; padding: 20px; border-top-left-radius: 10px; border-top-right-radius: 10px;'>
                                    <h1 style='margin: 0; font-size: 24px; text-align: center;'>Pengajuan Ditolak</h1>
                                </div>
                                ...
                                <div style='padding: 30px;'>
                                    ...
                                    <div style='background-color: #fff3cd; border-left: 5px solid #ffc107; padding: 15px; margin-bottom: 20px;'>
                                        <p style='margin: 0; color: #856404;'>
                                            Kami sampaikan bahwa <strong>Pengajuan Anda Tidak Dapat Diproses</strong>.
                                        </p>
                                    </div>
                                    ...
                                    <table style='width: 100%; border-collapse: collapse; margin-bottom: 20px;'>
                                        ...
                                        <tr style='background-color: #f8f9fa;'>
                                            ...
                                            <td style='padding: 10px; color: #dc3545; font-weight: bold;'>DITOLAK</td>
                                        </tr>
                                    </table>
                                    ...
                                    <div style='background-color: #f1f3f5; border-radius: 5px; padding: 15px; margin-bottom: 20px;'>
                                        <p style='margin: 0; color: #2c3e50; font-style: italic;'>
                                            Kami mohon maaf atas ketidaknyamanan ini. Silakan hubungi tim kami untuk informasi lebih lanjut.
                                        </p>
                                    </div>
                                    
                                    <div style='text-align: center; margin-top: 30px;'>
                                        <p style='color: #6c757d; margin-bottom: 10px;'>Terima kasih atas pengertiannya.</p>
            ...
            // Success message
            echo "<script>
                alert('Ajuan berhasil ditolak dan email notifikasi telah dikirim!');
                document.location='pengajuan.php';
            </script>";
            exit();
        } catch (Exception $e) {
            ...
            echo "<script>
                alert('Ajuan berhasil ditolak, tetapi gagal mengirim email notifikasi: " . $mail->ErrorInfo . "');
                document.location='pengajuan.php';
            </script>";
            exit();
        }
