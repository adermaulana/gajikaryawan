...
if (isset($_POST['update'])) {
    $id = mysqli_real_escape_string($koneksi, $_POST['id_jabatan']);
    ...
    if ($update) {
        ...
        echo "<script>
                ...
                document.location='editjabatan.php?id=$id';
              </script>";
    }
}
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="jabatan.php" class="btn btn-success btn-icon-split">
                            ...
                            <form method="post" class="user" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="text" name="jabatan" class="form-control form-control-user col-6"
                                        placeholder="Jabatan" required value="<?= $data['jabatan'] ?? '' ?>">
                                </div>
                                <div class="form-group">
                                    <input type="number" name="gaji" class="form-control form-control-user col-6"
                                        placeholder="Gaji" required value="<?= $data['gaji'] ?? '' ?>">
                                </div>
                                <div class="form-group">
