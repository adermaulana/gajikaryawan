<?php
    ...
    session_start();
        ...
        if(isset($_POST['simpan'])){
            $simpan = mysqli_query($koneksi, "INSERT INTO karyawan (nama, jabatan,departemen, gaji_pokok, status) VALUES ('$_POST[nama]','$_POST[jabatan]','$_POST[departemen]','$_POST[gaji_pokok]','$_POST[status]')");
